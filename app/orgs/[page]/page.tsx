    ...
    <div className="flex overflow-hidden w-full" style={{ backgroundColor: isDark ? '#0d1117' : '#f9fafb' }}>
      ...
      <div className="flex-1 overflow-y-auto px-8 py-8">
        ...
        <div className="space-y-6 max-w-4xl">
          ...
          {/* ── Org Scanner Settings ── */}
          <details className="group">
            <summary className="cursor-pointer list-none">
              <div className="flex items-center gap-2 px-4 py-3 rounded-xl border shadow-sm select-none" style={card}>
                <StorageIcon sx={{ fontSize: 18 }} style={{ color: textSecondary }} />
                <span className="text-sm font-semibold" style={{ color: textPrimary }}>Org Scanner Settings</span>
                <span className="text-xs ml-1" style={{ color: textSecondary }}>(GitHub connection, PATs, tracked repos)</span>
                <span className="ml-auto text-xs" style={{ color: textSecondary }}>
            ...
            </div>{/* end scanner settings content */}
          </details>
